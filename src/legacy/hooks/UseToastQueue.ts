...
import type ToastQueueHookProperties from "@/legacy/interfaces/props/ToastQueueHookProperties.ts";
import type {ToastMessageType} from "@/legacy/interfaces/types/toastMessageType.ts";
import type {ToastModalProperties} from "@/legacy/interfaces/props/ToastModalProperties.ts";
